        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-40">
          ...
          <div>
            <motion.h3 
              ...
              className="text-2xl font-bold text-white mb-8 flex items-center gap-3"
            >
              <Swords className="text-secondary w-6 h-6" />
            ...
            >
              <div>
                <h4 className="text-2xl font-bold text-white mb-2">District-Level Winner</h4>
                <div className="text-secondary font-mono text-xs uppercase tracking-widest mb-2">Karate Competition</div>
                <div className="text-gray-500 font-mono text-xs uppercase tracking-widest mb-6 border border-white/10 inline-block px-2 py-1 rounded">Yellow Belt</div>
                
                <p className="text-gray-400 leading-relaxed mb-8">
                  Karate developed discipline, resilience, consistency, mental focus, and perseverance.
                </p>
              </div>

              <div className="flex flex-wrap gap-2">
                {["Discipline", "Focus", "Resilience", "Consistency"].map(tag => (
                  <span key={tag} className="text-[10px] font-mono px-3 py-1 rounded bg-secondary/10 border border-secondary/20 text-secondary">
                    {tag}
                  </span>
                ))}
              </div>
