...
import { Award, Trophy, Users, Code, Zap, Target, Workflow, Server, BrainCircuit, Globe, Rocket, Shield } from "lucide-react";
...
const PARTICIPATION = [
  ...
  { name: "CodeFest’26", org: "IIT BHU", year: "2026", icon: <Zap className="w-6 h-6" /> },
