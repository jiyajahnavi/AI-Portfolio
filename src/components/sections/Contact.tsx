...
import { Mail, MessageSquare, Terminal, ExternalLink, Hexagon, Code2, TerminalSquare } from "lucide-react";
...
export default function Contact() {
  const socialLinks = [
    ...
    {
      name: "HackerRank",
      url: "https://www.hackerrank.com/jiyajahnavi",
      icon: <TerminalSquare className="w-6 h-6" />,
      handle: "jiyajahnavi",
      color: "hover:text-[#2EC866] hover:border-[#2EC866]/40 hover:bg-[#2EC866]/5",
      delay: 0.5
    },
    {
      name: "CodeChef",
      url: "https://www.codechef.com/users/jiyajahnavi",
      icon: <Code2 className="w-6 h-6" />,
      handle: "jiyajahnavi",
      color: "hover:text-[#5B4638] hover:border-[#5B4638]/40 hover:bg-[#5B4638]/5",
      delay: 0.6
    }
  ];
